...
// Action to add menu
add_action('admin_menu', 'wpbws_register_design_page');
 ...
 * @since 1.0.0
 */
function wpbws_register_design_page() {
	//add_submenu_page( 'edit.php?post_type='.WPBAW_POST_TYPE, __('How it works, our plugins and offers', 'buttons-with-style'), __('How It Works', 'buttons-with-style'), 'manage_options', 'wpbawh-designs', 'wpbws_designs_page' );
	add_menu_page( __('How it works, our plugins and offers', 'buttons-with-style'), __('How It Works - BWS', 'buttons-with-style'), 'manage_options', 'wpbws-designs', 'wpbws_designs_page' );
}
 ...
 * @since 1.0.0
 */
function wpbws_designs_page() {

	$wpos_feed_tabs = wpbws_help_tabs();
	...
	<div class="wrap wpbawh-wrap">
		...
		<h2 class="nav-tab-wrapper">
			...
			foreach ($wpos_feed_tabs as $tab_key => $tab_val) {
				...
				$tab_link 	= add_query_arg( array( 'page' => 'wpbws-designs', 'tab' => $tab_key), admin_url('edit.php') );
			?>
		...
		<?php
			if( isset($active_tab) && $active_tab == 'how-it-work' ) {
				wpbws_howitwork_page();
			}
			else if( isset($active_tab) && $active_tab == 'plugins-feed' ) {
				echo wpbws_get_plugin_design( 'plugins-feed' );
			} else {
				echo wpbws_get_plugin_design( 'offers-feed' );
			}
		?>
 ...
 * @since 1.0.0
 */
function wpbws_get_plugin_design( $feed_type = '' ) {
										...
										<tbody>
											...
											<tr>
												...
												<td> 													
													...
													<span class="wpbawh-shortcode-preview">[bws_button name="button-name" type="square" link="http://www.goggle.com" class="success" style="shadow" target="blank" icon_class="star" icon_size="medium"]</span> <br />
											...
											<tr>
												<th>
													<label><?php _e('Need Support?', 'buttons-with-style'); ?></label>
												</th>
												<td>
													<p><?php _e('Check plugin document for shortcode parameters and demo for designs.', 'buttons-with-style'); ?></p> <br/>
													<a class="button button-primary" href="http://demo.wponlinesupport.com/buttons-with-style-demo/" target="_blank"><?php _e('Demo for Designs', 'buttons-with-style'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">										
										<p>Enjoyed this plugin? You can help by rate this plugin <a href="https://wordpress.org/support/plugin/buttons-with-style/reviews/?filter=5" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
